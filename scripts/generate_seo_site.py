...
ARTICLES = [
    ...
    },
    {
        ...
        "method": "对每箱计算最长边，并与渠道阈值对照。中国 EMS 产品页面显示国际 EMS/e 特快在任一单边长度超过 40cm 时开始计泡；2022 通知也说明相关计泡阈值可能调整，不能沿用较早经验。实际发货仍需按产品和目的地复核。",
        ...
        "mistakes": ["仍按旧的长边经验判断。", "只看体积重，不看尺寸限制。", "把一个产品的规则套到所有 EMS 产品。", "没有把长条货从混装中单独标出。"],
    ...
    },
    {
        ...
        "description": "解释中国 EMS 国际 EMS/e 特快超过 40cm 进入计泡复核和 /6000 公式，并提醒较早长边认知已经可能过时。",
        "keyword": "EMS 40cm 计泡",
        ...
        "mistakes": ["继续使用较早长边经验。", "只看重量不看长边。", "把 EMS 所有产品视为同一规则。", "没有保存官方确认口径。"],
        "sources": source("ems_product", "ems_notice"),
    },
    {
